...
- [~] **B5 — Community + Events** (rozbite na dwa shippable podsystemy):
  ...
  - [ ] **B5b — Events:** wydarzenia online/live/klan, zapisy + capacity + waitlist, klan-gating przez membership, płatne bilety przez Stripe.
