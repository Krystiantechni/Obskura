    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "code",
                    models.CharField(
                        choices=[("free", "Próg (free)"), ("solo", "Solo"), ("klan", "Klan")],
                        max_length=8,
                        unique=True,
                        verbose_name="kod planu",
                    ),
                ),
                ...
                (
                    "cta_label",
                    models.CharField(blank=True, max_length=40, verbose_name="etykieta CTA"),
                ),
                (
                    "monthly_quota",
                    models.PositiveIntegerField(
                ...
                (
                    ...
                    models.CharField(
                        blank=True, max_length=120, verbose_name="Stripe price id (mc)"
                    ),
                ),
                (
                    "stripe_price_id_year",
                    models.CharField(
                        blank=True, max_length=120, verbose_name="Stripe price id (rok)"
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name="wymaga aplikacji"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "credit_name",
                    models.CharField(blank=True, max_length=80, verbose_name="podpis w napisach"),
                ),
                (
                    "anon_number",
                    models.PositiveIntegerField(
                ...
                (
                    "company_name",
                    models.CharField(blank=True, max_length=120, verbose_name="nazwa firmy"),
                ),
                (
                    "stripe_checkout_session_id",
                    models.CharField(
                        blank=True, max_length=120, verbose_name="Stripe checkout session id"
                    ),
                ),
                (
                    "stripe_payment_intent_id",
                    models.CharField(
                        blank=True, max_length=120, verbose_name="Stripe payment intent id"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "period_start",
                    models.DateTimeField(blank=True, null=True, verbose_name="początek okresu"),
                ),
                (
                    "period_end",
                    models.DateTimeField(
                        blank=True, db_index=True, null=True, verbose_name="koniec okresu"
                    ),
                ),
                (
                    "trial_end",
                    models.DateTimeField(
                        blank=True, null=True, verbose_name="koniec okresu próbnego"
                    ),
                ),
                ("auto_renew", models.BooleanField(default=True, verbose_name="auto-odnawianie")),
                (
                    "cancel_at_period_end",
                    models.BooleanField(default=False, verbose_name="anuluj na koniec okresu"),
                ),
                (
                    "stripe_customer_id",
                    models.CharField(blank=True, max_length=120, verbose_name="Stripe customer id"),
                ),
                (
                    "stripe_subscription_id",
                    models.CharField(
                        blank=True, max_length=120, verbose_name="Stripe subscription id"
                    ),
                ),
                (
                    "plan",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "abstract": False,
                "indexes": [
                    models.Index(fields=["user", "period"], name="membership__user_id_7ba737_idx")
                ],
                "constraints": [
