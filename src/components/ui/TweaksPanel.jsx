...
export default function TweaksPanel({ variant, onChange }) {
  ...
  return (
    <div className="fixed bottom-[88px] right-6 z-[200] min-w-[260px] border border-line bg-bg-1/98 px-5 py-[18px] shadow-[0_30px_60px_-10px_rgba(0,0,0,0.8),0_0_0_1px_rgba(255,42,42,0.08)] backdrop-blur-md">
