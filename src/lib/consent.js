// [cookies-off] Stub — feature wyłączony. Aby przywrócić: usuń ten blok stuba i odkomentuj oryginał poniżej.
export function getConsent() { return null; }
export function setConsent() {}
export function hasConsent() { return true; }   // permisywne — gating wyłączony
export function hasAnalyticsConsent() { return false; }
