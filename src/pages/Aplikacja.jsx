...
function IosHomeScreen() {
  const rows = [
    { img: "/images/monster.png", pos: "center 20%", ep: "S03 · E12 · 19:43 / 47:12", t1: "Mgła nad", t2: "Wisłoujściem", d: "42% · WCZORAJ" },
    { img: "/images/img-orbs.png", pos: "center 25%", ep: "S03 · E08 · 12:08 / 01:02:47", t1: "Sygnał z", t2: "orbity", d: "19% · PORZUCONE" },
  ];
  const recos = [
    { img: "/images/img-hallway.png", pos: "center", ep: "S03 · E11 · PSYCHOLOGICAL", t1: "Ostatnie", t2: "Światło", d: "52:08 · ★ 4.9" },
    { img: "/images/img-creature.png", pos: "center 15%", ep: "S03 · E04 · TRUE HORROR", t1: "Dom przy", t2: "ul. Cisowej 7", d: "38:21 · ★ 4.9" },
    { img: "/images/img-wolf.png", pos: "center 28%", ep: "S03 · E06 · MYTHOLOGY", t1: "Łańcuch", t2: "Fenrira", d: "01:22:55 · ★ 5.0" },
  ];
  ...
  return (
    <div className="h-full overflow-y-auto bg-bg-0 pb-24 text-ink-0">
      ...
      <div className="relative h-[300px] overflow-hidden">
        <img src="/images/dada.png" alt="" loading="lazy" decoding="async" className="h-full w-full object-cover" />
  ...
  return (
    <div className="relative h-full overflow-hidden">
      <div className="absolute inset-0">
        <img src="/images/monster.png" alt="" loading="lazy" decoding="async" className="h-full w-full object-cover brightness-50" />
...
function AndroidBrowseScreen() {
  ...
  const cards = [
    { img: "/images/img-hallway.png", t1: "Ostatnie", t2: "Światło" },
    { img: "/images/img-forest.png", t1: "Coś patrzy", t2: "z lasu" },
    { img: "/images/img-tunnel.png", t1: "Pod", t2: "betonem" },
    { img: "/images/img-wolf.png", t1: "Łańcuch", t2: "Fenrira" },
  ];
  return (
    <div className="h-full overflow-y-auto bg-bg-0 pb-20 text-ink-0">
      ...
      <div className="relative mx-4 mb-6 aspect-[16/11] overflow-hidden rounded-2xl bg-bg-1">
        <img src="/images/img-creature.png" alt="" loading="lazy" decoding="async" className="h-full w-full object-cover object-[center_15%]" />
      ...
      <div className="absolute inset-x-0 bottom-6 z-30 grid grid-cols-[44px_1fr_auto] items-center gap-3 border-t border-red/30 bg-bg-2/95 px-3 py-2.5 backdrop-blur-xl before:absolute before:left-0 before:top-0 before:h-0.5 before:w-[47%] before:bg-red before:shadow-[0_0_8px_rgba(255,42,42,0.5)] before:content-['']">
        <span className="h-11 w-11 bg-cover" style={{ backgroundImage: "url('/images/monster.png')", backgroundPosition: "center 20%" }} />
