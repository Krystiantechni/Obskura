            ...
            <div className="relative border border-white/8 bg-[linear-gradient(180deg,rgba(15,18,24,0.95),rgba(10,13,18,0.98))] p-6">
              ...
              <div className="mb-5 flex items-center gap-4">
                ...
                <div className="ml-auto flex gap-3">
                  <button onClick={() => setLiked((l) => !l)} className={`grid h-11 w-11 place-items-center border transition-colors ${liked ? "border-red text-red" : "border-white/10 text-ink-1 hover:border-red hover:text-red"}`}>{liked ? <HeartFill /> : <Heart />}</button>
                  <button className="grid h-11 w-11 place-items-center border border-white/10 text-ink-1 transition-colors hover:border-red hover:text-red"><Share /></button>
                  <button className="grid h-11 w-11 place-items-center border border-white/10 text-ink-1 transition-colors hover:border-red hover:text-red"><List /></button>
                </div>
              </div>
