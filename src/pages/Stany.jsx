  ...
  return (
    <div className="w-full max-w-[680px] text-center">
      ...
      <div className="mt-9 border border-line bg-bg-2/50 text-left">
        ...
        <OfflineRow img="/images/monster.png" pos="center 20%" ep="S03 · E12" t1="Mgła nad" em="Wisłoujściem" size="412 MB" />
        <OfflineRow img="/images/img-hallway.png" pos="center" ep="S03 · E11" t1="Ostatnie" em="Światło" size="487 MB" />
        <OfflineRow img="/images/img-creature.png" pos="center 15%" ep="S03 · E04" t1="Dom przy" em="ul. Cisowej 7" size="356 MB" />
      </div>
