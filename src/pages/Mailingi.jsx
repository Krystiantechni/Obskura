    ...
    <>
      {tpl === "welcome" && (
        <>
          ...
          <div className="px-9 pb-12 pt-9">
            ...
            <MailCard img="/images/img-hallway.png" pos="center" ep="S03 · E11 · Wybrane dla ciebie" t1="Ostatnie" em="Światło" meta="52:08 · ★ 4.9 · Psychological" />
      ...
      {tpl === "newsletter" && (
        <div className="px-9 pb-12 pt-9">
          ...
          <MailCard img="/images/monster.png" pos="center 25%" ep="S03 · E12 · Wygasa w 71h" t1="Mgła nad" em="Wisłoujściem" meta="47:12 · Binaural · K. Wieczorek" />
      ...
      {tpl === "premiere" && (
        <>
          <div className="relative h-[200px] overflow-hidden after:absolute after:inset-0 after:bg-[linear-gradient(180deg,transparent_60%,rgba(10,13,18,0.95))]">
            <img src="/images/monster.png" alt="" loading="lazy" decoding="async" className="h-full w-full object-cover object-[center_25%]" />
          </div>
          <div className="px-9 pb-12 pt-9">
            ...
            <MailCard img="/images/dada.png" pos="center 30%" ep="S03 · E12 · Finał sezonu" t1="Mgła nad" em="Wisłoujściem" meta="47:12 · Cosmic dread · 18+ · Binaural 3D" />
